 ...
 */
function CapsuleCmsImageList()
{
    if (CapsuleCmsImageList.hasOwnProperty('instance')) {
        var m = 'Instance already exists. Only one instance allowed!';
        console.log(m);
        throw new Error(m);
    } else {
        CapsuleCmsImageList.instance = this;
    }
     ...
     * @type {string}
     */
    var class_prefix = 'capsule-cms-image-list-';
    ...
    var create_window = function ()
    {
        ...
        {
            CapsuleCmsImageList.getInstance().purgeWindow();
        });
        ...
        button_more.click(function ()
        {
            ...
            CapsuleCmsImageList.getInstance().purgeWindow();
            CapsuleCmsImageList.getInstance().showWindow();
        });
 ...
 * Static method
 */
CapsuleCmsImageList.getInstance = function ()
{
    if (CapsuleCmsImageList.hasOwnProperty('instance')) {
        return CapsuleCmsImageList.instance;
    }
    return new CapsuleCmsImageList();
};
